 ...
 */
final class Version20260209230246 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE exercise_execution (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, short VARCHAR(50) NOT NULL, description VARCHAR(255) NOT NULL, PRIMARY KEY (id))');
        ...
        $this->addSql('CREATE TABLE workout_exercise (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, rest_time INT DEFAULT NULL, note VARCHAR(255) DEFAULT NULL, exercise_id INT NOT NULL, exercise_execution_id INT DEFAULT NULL, workout_id INT DEFAULT NULL, PRIMARY KEY (id))');
